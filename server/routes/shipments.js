        ...
        const result = await pool.query(
            `UPDATE shipments 
             SET status = COALESCE($1, status), 
                 ...
                 cbm = COALESCE($22, cbm),
                 no_of_pkgs = COALESCE($23, no_of_pkgs),
                 expense_macl = COALESCE($24, expense_macl),
                 expense_mpl = COALESCE($25, expense_mpl),
                 expense_mcs = COALESCE($26, expense_mcs),
                 expense_transportation = COALESCE($27, expense_transportation),
                 expense_liner = COALESCE($28, expense_liner),
                 house_bl = COALESCE($29, house_bl),
                 vessel = COALESCE($30, vessel),
